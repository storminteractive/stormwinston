...
const exportFunc = (serviceName) => {
    ...
    return winston.createLogger({
        ...
        transports: [
          new winston.transports.File({ level: 'error', filename: './error.log', format: fileFormat }),
          new winston.transports.File({ level: 'debug', filename: './debug.log',format: fileFormat }),
...
// Usage: 
// const l = require('stormwinston')('main-app')
